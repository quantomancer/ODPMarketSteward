/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: eb8144eabae29b980564aa8d2ec5cbcc)
// Runtime types generated with workerd@1.20260714.1 2026-07-21 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	ACK_CHALLENGE_CURRENT_KEY_ID: "poc-2026-07";
	ACK_CHALLENGE_LIFETIME_SECONDS: "300";
	ACK_MAX_CLOCK_SKEW_SECONDS: "30";
	MCP_SESSION_AGENT: DurableObjectNamespace<import("./apps/worker/src/index").OdpMarketStewardAgent>;
	FXLIVE_SERVICE: Fetcher /* fxlive */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./apps/worker/src/index");
		durableNamespaces: "OdpMarketStewardAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ACK_CHALLENGE_CURRENT_KEY_ID" | "ACK_CHALLENGE_LIFETIME_SECONDS" | "ACK_MAX_CLOCK_SKEW_SECONDS">> {}
}
