...
try {
  ...
  if (
    ...
    acknowledgementTool?.inputSchema?.$id !==
      "urn:odp-market-steward:mcp:acknowledge_market_data_demo:input:v1.5.4" ||
    acknowledgementTool?.outputSchema?.$id !==
      "urn:odp-market-steward:mcp:acknowledge_market_data_demo:output:v1.5.4" ||
    ...
    marketBoardTool?.inputSchema?.$id !==
      "urn:odp-market-steward:mcp:get_fx_market_board:input:v1.5.4" ||
    marketBoardTool?.outputSchema?.$id !==
      "urn:odp-market-steward:mcp:get_fx_market_board:output:v1.5.4" ||
    ...
    productProfileTool?.inputSchema?.$id !==
      "urn:odp-market-steward:mcp:get_fx_product_profile:input:v1.5.4" ||
    productProfileTool?.outputSchema?.$id !==
      "urn:odp-market-steward:mcp:get_fx_product_profile:output:v1.5.4" ||
